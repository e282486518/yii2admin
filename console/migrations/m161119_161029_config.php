...
class m161119_161029_config extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%config}}',['id'=>'1','name'=>'WEB_SITE_TITLE','title'=>'网站标题','group'=>'1','type'=>'1','value'=>'内容管理框架122','extra'=>'','remark'=>'网站标题前台显示标题','create_time'=>'1378898976','update_time'=>'1479233715','sort'=>'0','status'=>'1']);
        $this->insert('{{%config}}',['id'=>'2','name'=>'WEB_SITE_DESCRIPTION','title'=>'网站描述','group'=>'1','type'=>'2','value'=>'内容管理框架1','extra'=>'','remark'=>'网站搜索引擎描述','create_time'=>'1378898976','update_time'=>'1479233697','sort'=>'1','status'=>'1']);
        $this->insert('{{%config}}',['id'=>'3','name'=>'WEB_SITE_KEYWORD','title'=>'网站关键字','group'=>'1','type'=>'2','value'=>'黄龙飞111','extra'=>'','remark'=>'网站搜索引擎关键字','create_time'=>'1378898976','update_time'=>'1479233697','sort'=>'8','status'=>'1']);
...
4:枚举','extra'=>'','remark'=>'主要用于数据解析和页面表单的生成','create_time'=>'1378898976','update_time'=>'1463024244','sort'=>'2','status'=>'1']);
        $this->insert('{{%config}}',['id'=>'10','name'=>'WEB_SITE_ICP','title'=>'网站备案号','group'=>'1','type'=>'1','value'=>'沪ICP备12007941号-2','extra'=>'','remark'=>'设置在网站底部显示的备案号，如“沪ICP备12007941号-2','create_time'=>'1378900335','update_time'=>'1479233697','sort'=>'9','status'=>'1']);
...
blue_color:紫罗兰','remark'=>'后台颜色风格','create_time'=>'1379122533','update_time'=>'1479233697','sort'=>'10','status'=>'1']);
