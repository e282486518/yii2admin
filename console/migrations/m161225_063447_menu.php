...
class m161225_063447_menu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%menu}}',['id'=>'83','title'=>'删除','pid'=>'80','sort'=>'0','url'=>'article-cat/remove','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'84','title'=>'移动','pid'=>'80','sort'=>'0','url'=>'article-cat/operate/type/move','hide'=>'0','group'=>'','status'=>'1']);
        $this->insert('{{%menu}}',['id'=>'85','title'=>'合并','pid'=>'80','sort'=>'0','url'=>'article-cat/operate/type/merge','hide'=>'0','group'=>'','status'=>'1']);
        ...
        $this->insert('{{%menu}}',['id'=>'166','title'=>'商品属性管理','pid'=>'2','sort'=>'21','url'=>'traintype/index','hide'=>'0','group'=>'商城管理|icon-basket','status'=>'1']);
