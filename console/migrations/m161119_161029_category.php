...
class m161119_161029_category extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%category}}',['id'=>'1','pid'=>'0','name'=>'about','title'=>'关于我们','link'=>'','extend'=>'','meta_title'=>'','keywords'=>'','description'=>'','create_time'=>'1379474947','update_time'=>'1476341718','sort'=>'2','status'=>'1']);
